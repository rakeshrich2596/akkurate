...
const services = [
  [
    "User Research",
    "Understand users, tasks, pain points and business goals before interface decisions are made.",
  ],
  [
    "User Flows",
    "Map the paths users take to complete key tasks and identify unnecessary friction.",
  ],
  [
    "Wireframes",
    "Create low-fidelity structures to test information hierarchy before visual polish.",
  ],
  [
    "UI Design",
    "Design accessible, consistent interfaces around the brand and product requirements.",
  ],
  [
    "Prototyping",
    "Prototype important journeys so stakeholders can review interactions before development.",
  ],
  [
    "Design Systems & Handoff",
    "Create reusable components and specifications that make development more consistent.",
  ],
];
const outcomes = [
  ...
  "Stronger developer handoff",
  "More confident product decisions",
];
const audienceCards = [
  [
    "Product teams",
    "When user journeys, workflows or interfaces need clearer structure before further development.",
  ],
  [
    "Growing digital products",
    "When new features and audiences create a need for reusable patterns and stronger consistency.",
  ],
  [
    "Existing products",
    "When focused usability improvements can create more value than redesigning every screen.",
  ],
];
const processSteps = [
  [
  ...
  [
    "User Flows",
    "Translate the objective into practical flows, scope, interface direction and a measurement plan.",
  ],
  [
    "Wireframes",
    "Create, optimize and structure the agreed journeys with brand and user requirements in mind.",
  ],
  [
    "UI & Prototype",
    "Test interactions, messaging and key task paths before considering the work complete.",
  ],
  [
    "Testing & Handoff",
    "Review feedback and business signals, then deliver reusable components and development-ready specifications.",
  ],
];
const metrics = [
  ["91%", "Usability"],
...
const relatedServices = [
  [
    "Website Design",
    "/website-design",
    "Translate UX thinking into clear website structures and visual experiences.",
  ],
  [
    "Website Development",
    "/website-development",
    "Turn validated designs into responsive digital experiences.",
  ],
  [
    "Web Application",
    "/web-application",
    "Apply UX patterns to complex workflows and product systems.",
  ],
];
...
const faqs = [
  [
    "What is included in your ui/ux design service?",
...
========================================================= */}
    ...
    ===================================================== */}
          ...
          <div className="mb-5 flex items-center gap-2 text-[11px] font-medium text-gray-500 sm:mb-6 sm:text-[12px]">
            ...
            <span className="font-medium text-[#1455d9]">UI/UX Design</span>
          </div>

          {/* =====================================================
        HERO GRID
        LEFT + RIGHT SAME TOP LINE
    ===================================================== */}
      ...
      =================================================== */}
            ...
            <Reveal direction="left">
              <div className="max-w-[760px] pt-15">
                ...
                <h1 className="m-0 max-w-[760px] text-[35px] font-bold leading-[1.04] tracking-[-.045em] text-[#101828] sm:text-[44px] md:text-[45px] lg:text-[45px] xl:text-[37px]">
                  Make Every Digital Interaction Easier
                </h1>

                {/* DESCRIPTION */}

                <p className="mt-5 max-w-[660px] text-[14px] leading-7 text-gray-600 sm:text-[15px] lg:text-[16px]">
                  Design intuitive digital experiences that reduce friction,
                  improve usability and help users complete important actions —
      ...
      =================================================== */}
          ...
          ================================================= */}
                ...
                <div className="pointer-events-none absolute left-1/2 top-1/2 h-[380px] w-[380px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-100/60 blur-[100px]" />
          ...
          ================================================= */}
                ...
                >
                  <path
                    d="M95 135 C190 70 250 100 325 150 C405 205 465 130 550 170"
                    stroke="#dbeafe"
                    strokeWidth="2"
                    strokeDasharray="6 8"
                    className="animate-[journeyDash_4s_linear_infinite]"
                  />

                  <path
                    d="M550 170 C500 240 445 285 380 315 C300 350 225 330 120 390"
                    stroke="#e0e7ff"
                    strokeWidth="2"
                    strokeDasharray="6 8"
                    className="animate-[journeyDash_4s_linear_infinite]"
                  ...
                  <circle
                    ...
                    r="5"
                    fill="#1455d9"
                    className="animate-[journeyDot_7s_ease-in-out_infinite]"
                  />
                </svg>
          ...
          ================================================= */}
                ...
                <div className="absolute left-[4%] top-[18%] z-30 w-[150px] rounded-[22px] border border-white bg-white p-2.5 shadow-[0_22px_55px_rgba(15,23,42,.12)] animate-[screenOne_7s_ease-in-out_infinite]">
                  <div className="overflow-hidden rounded-[16px] border border-gray-100">
                    <div className="flex h-6 items-center gap-1 bg-[#101828] px-2">
                    ...
                    <div className="bg-[#f8faff] p-3">
                      <span className="text-[5px] font-bold uppercase tracking-[.15em] text-[#1455d9]">
                        Step 01
                      </span>

                      <p className="mt-2 m-0 text-[11px] font-black leading-3 text-[#101828]">
                        Welcome to
                        <br />
                        something better.
                      </p>

                      <div className="mt-3 h-1.5 w-[80%] rounded-full bg-gray-200" />

                      <div className="mt-1.5 h-1.5 w-[55%] rounded-full bg-gray-100" />

                      <button className="mt-3 rounded-full bg-[#073b91] px-3 py-1.5 text-[6px] font-bold text-white">
                        Explore →
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="mt-2 flex items-center justify-between">
                    ...
                    <span className="text-[6px] uppercase tracking-[.12em] text-gray-400">
                      First impression
                    </span>
                  </div>
                </div>
          ...
          ================================================= */}
                ...
                <div className="absolute right-[3%] top-[22%] z-30 w-[155px] rounded-[22px] border border-white bg-white p-2.5 shadow-[0_22px_55px_rgba(15,23,42,.12)] animate-[screenTwo_7s_ease-in-out_infinite]">
                  <div className="rounded-[16px] bg-[#101828] p-2.5">
                    <div className="flex items-center justify-between">
                      <span className="text-[6px] font-bold uppercase tracking-[.12em] text-blue-300">
                        Explore
                      </span>
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-1.5">
                      <div className="h-14 rounded-xl bg-blue-400/20 p-2">
                        <div className="h-4 w-4 rounded-lg bg-blue-300/40" />

                        <div className="mt-3 h-1.5 w-[70%] rounded-full bg-white/20" />
                      </div>

                      <div className="h-14 rounded-xl bg-violet-400/20 p-2">
                        <div className="h-4 w-4 rounded-lg bg-violet-300/40" />
          ...
          ================================================= */}
                ...
                <div className="absolute left-1/2 top-[54%] z-40 w-[200px] -translate-x-1/2 -translate-y-1/2 sm:w-[220px]">
                  <div className="relative rounded-[34px] border-[6px] border-[#101828] bg-[#101828] p-1.5 shadow-[0_35px_90px_rgba(15,23,42,.25)]">
                    {/* PHONE TOP */}

                    <div className="absolute left-1/2 top-1 z-50 h-4 w-20 -translate-x-1/2 rounded-full bg-[#101828]" />

                    {/* SCREEN */}

                    <div className="relative h-[320px] overflow-hidden rounded-[27px] bg-[#f8faff]">
                      {/* MAIN SCREEN */}

                      <div className="absolute inset-0 animate-[uiScreens_7s_ease-in-out_infinite]">
                        <div className="flex items-center justify-between px-4 pt-7">
                          <div>
                            <p className="m-0 text-[6px] font-bold uppercase tracking-[.16em] text-[#1455d9]">
                              Experience
                            </p>

                            <p className="m-0 mt-1 text-[13px] font-black text-[#101828]">
                              Hello there.
                            </p>
                          </div>
                        ...
                        <div className="mx-4 mt-5 rounded-[20px] bg-[#101828] p-4">
                          <div className="h-20 rounded-[15px] bg-gradient-to-br from-blue-300/30 to-violet-300/20">
                            <div className="flex h-full items-center justify-center">
                              <div className="h-12 w-12 rounded-full border border-blue-300/40 bg-blue-300/10 animate-pulse" />
                            </div>
                          </div>
                          ...
                          <div className="mt-2 h-1.5 w-[70%] rounded-full bg-white/15" />
                        </div>
                        ...
                        <div className="mt-4 px-4">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[6px] text-[#1455d9]">
                              View all
                            </span>
                          </div>

                          <div className="mt-2 flex gap-2">
                            <div className="h-20 flex-1 rounded-[15px] border border-gray-100 bg-white p-2 shadow-sm">
                              <div className="h-8 rounded-lg bg-blue-50" />

                              <div className="mt-2 h-1.5 w-[70%] rounded-full bg-gray-200" />
                            </div>
                        ...
                        <div className="absolute bottom-5 left-4 right-4">
                          <div className="flex h-10 items-center justify-center rounded-full bg-[#073b91] text-[7px] font-bold text-white shadow-lg">
                            Continue
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="absolute inset-0 bg-[#f8faff] p-4 opacity-0 animate-[productScreen_7s_ease-in-out_infinite]">
                        <div className="pt-5">
                          <span className="text-[6px] font-bold uppercase tracking-[.15em] text-[#1455d9]">
                            Step 03
                          </span>

                          <p className="mt-2 m-0 text-[18px] font-black text-[#101828]">
                            Product
                          </p>
                        </div>

                        <div className="mt-5 h-28 rounded-[20px] bg-gradient-to-br from-blue-100 via-indigo-50 to-violet-100">
                          <div className="flex h-full items-center justify-center">
                            <div className="h-16 w-16 rotate-12 rounded-[20px] bg-white shadow-xl" />
                          </div>
                        </div>

                        <p className="mt-4 m-0 text-[11px] font-bold text-[#101828]">
                          Smart design.
                        </p>

                        <p className="mt-1 text-[7px] leading-3 text-gray-400">
                          Everything you need in one simple experience.
                        </p>

                        <div className="mt-5 flex items-center justify-between">
                          <span className="text-[16px] font-black text-[#101828]">
                            $129
                          </span>

                          <span className="rounded-full bg-[#073b91] px-4 py-2 text-[6px] font-bold text-white">
                            Add to cart
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="absolute inset-0 bg-[#f8faff] p-4 opacity-0 animate-[checkoutScreen_7s_ease-in-out_infinite]">
                        <div className="pt-5">
                          <span className="text-[6px] font-bold uppercase tracking-[.15em] text-[#1455d9]">
                            Step 04
                          </span>
                        ...
                        <div className="mt-5 rounded-[18px] border border-gray-100 bg-white p-3">
                          <div className="flex items-center gap-2">
                            <div className="h-9 w-9 rounded-xl bg-blue-50" />

                            <div className="flex-1">
                              <div className="h-1.5 w-[65%] rounded-full bg-gray-200" />

                              <div className="mt-1.5 h-1.5 w-[40%] rounded-full bg-gray-100" />
                            </div>
                          ...
                          <div className="mt-4 flex justify-between">
                            ...
                            <span className="text-[11px] font-black text-[#101828]">
                              $129
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="mt-4 space-y-2">
                          <div className="h-9 rounded-xl border border-gray-100 bg-white" />

                          <div className="h-9 rounded-xl border border-gray-100 bg-white" />
                        </div>

                        <div className="mt-4 flex h-10 items-center justify-center rounded-full bg-[#073b91] text-[7px] font-bold text-white">
                          Complete Purchase
                        </div>
                      </div>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#101828] p-5 text-center opacity-0 animate-[successScreen_7s_ease-in-out_infinite]">
                        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-400/10">
                          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-emerald-400 text-xl text-[#101828] animate-[successPop_7s_ease-in-out_infinite]">
                            ✓
                          </div>
                        </div>

                        <p className="mt-5 m-0 text-[17px] font-black text-white">
                          Success!
                        </p>

                        <p className="mt-2 max-w-[130px] text-[7px] leading-3 text-white/40">
                          A simple experience leads to confident action.
                        </p>

                        <div className="mt-5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[6px] font-bold uppercase tracking-[.12em] text-blue-300">
                          Journey complete
                        </div>
                      </div>
                    </div>
              ...
              ================================================= */}
                    ...
                    <div className="pointer-events-none absolute z-[100] animate-[cursorJourney_7s_ease-in-out_infinite]">
                      <div className="relative">
                        <svg
                          ...
                          viewBox="0 0 28 34"
                          fill="none"
                          className="drop-shadow-[0_4px_8px_rgba(15,23,42,.25)]"
                        >
                          <path
                            d="M3 2L24 21L15 22L20 31L15 34L10 24L4 30L3 2Z"
                            fill="white"
                            stroke="#101828"
                            strokeWidth="2"
                        ...
                        <div className="absolute left-1/2 top-1/2 h-10 w-10 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-blue-300 opacity-0 animate-[clickPulse_7s_ease-in-out_infinite]" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          ================================================= */}
                ...
                <div className="absolute bottom-[14%] left-[2%] z-50 w-[145px] rotate-[-5deg] rounded-[20px] border border-white bg-white/95 p-3 shadow-[0_22px_55px_rgba(15,23,42,.12)] animate-[floatUXCard_6s_ease-in-out_infinite] sm:w-[160px]">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="mt-3 m-0 text-[10px] font-bold leading-4 text-[#101828]">
                    "Make it simple."
                  </p>
          ...
          ================================================= */}
                ...
                <div className="absolute bottom-[13%] right-[2%] z-50 w-[145px] rotate-[5deg] rounded-[20px] bg-[#101828] p-3 shadow-[0_25px_60px_rgba(15,23,42,.2)] animate-[floatUXScore_7s_ease-in-out_infinite] sm:w-[160px]">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="mt-3 flex items-end gap-2">
                    <span className="text-[27px] font-black tracking-[-.05em] text-white">
                      92
                    </span>

                    <span className="mb-1 text-[7px] font-bold text-blue-300">
                      / 100
                    </span>
                  </div>

                  <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-white/10">
                    <div className="h-full w-[92%] rounded-full bg-blue-300 animate-[uxProgress_7s_ease-in-out_infinite]" />
                  </div>
          ...
          ================================================= */}
                ...
                <div className="absolute bottom-[1%] left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 whitespace-nowrap rounded-full border border-blue-100 bg-white/95 px-4 py-2.5 text-[7px] font-bold uppercase tracking-[.13em] text-gray-500 shadow-[0_12px_35px_rgba(15,23,42,.1)] backdrop-blur-md sm:text-[8px]">
                  <span className="text-[#1455d9]">Landing</span>
          ...
          <Reveal direction="left">
            <div className="mb-15">
              ...
              <h2 className="mt-4 m-0 max-w-[600px] text-[31px] font-bold leading-[1.08] tracking-[-.04em] text-[#101828] sm:text-[38px] lg:text-[30px]">
                Design Around What People Need to Accomplish.
              </h2>
            </div>
          </Reveal>
            ...
            <Reveal direction="up">
              <div className="h-full rounded-[24px] border border-gray-200 bg-[#f8faff] p-6 transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(15,23,42,.07)]">
                ...
                <p className="mt-3 m-0 text-[13px] leading-6 text-gray-500">
                  Akkurate Digital Solutions provides ui/ux design as part of an
            ...
            <div className="grid gap-7 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-[650px] text-[13px] leading-7 text-gray-300 sm:text-[14px]">
                  We connect business goals, user needs, task flows, interface
                  patterns and measurement so product decisions have a practical
                  purpose.
                </p>
              </div>
        ...
        <Reveal direction="up">
          <div className="mx-auto w-full max-w-[1200px] px-4 text-center sm:px-6 lg:px-8">
            ...
            <h2 className="mt-4 m-0 text-[27px] font-bold leading-tight tracking-[-.03em] text-white sm:text-[34px] lg:text-[42px]">
              Users Need Clarity, Not Just Beautiful Screens.
            </h2>
            <p className="mx-auto mt-5 max-w-[850px] text-[14px] leading-7 text-gray-300 sm:text-[15px]">
              Users struggle when they cannot find something, understand
              something or complete something. Akkurate focuses UI/UX work on
              clarity, task completion and confidence.
            </p>
            ...
            <Reveal direction="left">
              <div>
                ...
                <h2 className="mt-3 m-0 text-[30px] font-bold leading-[1.08] tracking-[-.04em] text-[#101828] sm:text-[38px] lg:text-[37px]">
                  Compare Actual UX Signals With the Target.
                </h2>
                <p className="mt-5 max-w-[560px] text-[14px] leading-7 text-gray-600">
                  Usability, satisfaction, task success and confidence can help
                  evaluate whether an experience is moving toward its intended
                  standard. Values are illustrative.
                </p>
                  ...
                  <div className="flex items-center justify-between border-b border-gray-100 pb-5">
                    <div>
                      ...
                      <p className="mt-1 m-0 text-[10px] text-gray-400">
                        Illustrative performance view for ui/ux design
                      </p>
                    </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[.75fr_1.25fr] lg:items-center lg:gap-20">
              ...
              <div>
                ...
                <h2 className="mt-3 m-0 text-[31px] font-bold leading-[1.08] tracking-[-.04em] text-[#101828] sm:text-[40px] lg:text-[40px]">
                  ...
                  <span className="block text-[#1455d9]">
                    People Understand & Enjoy.
                  </span>
                </h2>

                <p className="mt-5 m-0 max-w-[540px] text-[14px] leading-7 text-gray-600">
                  Good UI/UX design makes digital products easier to understand,
                  easier to use and more engaging. We focus on creating
                  intuitive experiences that connect user needs with your
                  business goals.
                </p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                "Easier website and product navigation",
                "Better user engagement",
                "More user-focused digital experiences",
                "Stronger connection between users and business goals",
              ].map((item, index) => (
            ...
            <Reveal direction="left">
              <div>
                ...
                <p className="mt-5 max-w-[520px] text-[13px] leading-7 text-gray-500">
                  UI/UX Design is relevant to businesses that have a clear
    ...
    <Reveal direction="up">
      <div className="mx-auto max-w-[800px] text-center">
        ...
        <p className="mt-5 text-[13px] leading-7 text-gray-400 sm:text-[14px]">
          A structured process keeps research, user flows, wireframes, UI design,
          prototyping, testing and handoff connected.
        </p>
              ...
              <div className="relative z-20 flex h-full w-[58%] flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 m-0 max-w-[270px] text-[10px] leading-[1.6] text-gray-400 sm:text-[11px]">
                    ...
                    your brand messages more dynamic, memorable and visually
                    impactful.
                  </p>
                </div>
        ...
        <Reveal direction="up">
          <div className="relative mt-20 overflow-hidden rounded-[26px] bg-gradient-to-r from-[#0b2443] via-[#7434e8] to-[#245fe5] px-6 py-9 shadow-[0_25px_80px_rgba(91,45,190,.22)] sm:px-9 sm:py-10 lg:px-11 lg:py-11">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto_auto] lg:items-center">
              <div>
                ...
                <h3 className="mt-2 m-0 max-w-[650px] text-[26px] font-bold leading-[1.12] tracking-[-.035em] text-white sm:text-[32px]">
                  Design digital experiences around what people need to
                  accomplish.
                </h3>
              ...
              >
                Start Your UX Project<span className="ml-2 text-[15px]">→</span>
              </a>
            ...
            <div className="relative mt-7 flex flex-wrap items-center gap-x-6 gap-y-3 border-t border-white/10 pt-4">
              {["Research", "Design", "Validate"].map((item, index) => (
