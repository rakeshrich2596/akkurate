...
const opportunities = [
  {
    ...
    description:
      "Develop this around real education customer intent, commercial context and proof. The final page should include examples and evidence specific to Akkurate's actual experience rather than generic claims.",
  },
  {
    number: "02",
...
const faqs = [
  {
    question:
      "Why should a education business use industry-specific digital marketing?",
    answer:
      ...
      <div className="w-full overflow-hidden bg-white text-[#101828]">
          ...
          <div className="relative mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 xl:px-10">
            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
              ...
              >
                ...
                <h1
                  data-animate="center"
                  className="mt-4 m-0 max-w-[760px] text-[34px] font-bold leading-[1.06] tracking-[-0.04em] text-[#101828] sm:text-[44px] md:text-[50px] lg:text-[35px]"
                >
                ...
                <p className="mt-6 max-w-[680px] text-[14px] leading-7 text-gray-600 sm:text-[16px]">
                  Education customers have a specific buying journey.
                ...
                >
                  Talk about Your Education Marketing Strategy
              ...
              >
                ...
                <div className="relative w-full max-w-[600px] overflow-hidden rounded-[28px]">

                  <img
                    src="/assets/images/content_images/education.png"
                    alt="Digital Marketing for Education"
                    className="
                      h-auto
                      w-full
                      object-cover
        ...
        <section className="px-14 py-16 sm:py-20 lg:py-24">
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div data-animate="left">
              ...
              <h2
                data-animate="center"
                className="mt-4 m-0 text-[25px] font-bold leading-tight tracking-[-0.03em] sm:text-[30px]"
              >
            ...
            <div data-animate="right">
              ...
              <p className="m-0 text-[14px] leading-7 text-gray-600 sm:text-[16px] sm:leading-8">
                ...
                education buyers search, compare and decide. The website should
                use industry language, answer relevant questions, demonstrate
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div data-animate="left">
              ...
              <p className="mt-5 max-w-[470px] text-[14px] leading-7 text-gray-600 sm:text-[15px]">
                A structured approach that connects education audience
        ...
        <section className="bg-[#101828] px-14 py-16 sm:py-20 lg:py-24">
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:items-center lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div data-animate="left">
              ...
              >
                A Customer-Journey-First Education Strategy
              </h2>
          ...
          <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            ...
            >
              ...
              <p className="mt-5 max-w-[430px] text-[14px] leading-7 text-gray-600 sm:text-[15px]">
                ...
                education marketing, channels, websites and performance.
              </p>
        ...
        <section className="relative overflow-hidden bg-[#073b91] px-14 py-10 sm:py-12 lg:py-14">
          ...
          >
            ...
            <h2 className="mt-0 m-0 text-[30px] font-bold leading-tight tracking-[-0.03em] text-white sm:text-[38px] lg:text-[46px]">
