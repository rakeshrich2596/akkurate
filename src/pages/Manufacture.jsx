...
const opportunities = [
  {
    ...
    description:
      "Develop this around real manufacturing customer intent, commercial context and proof. The final page should include examples and evidence specific to Akkurate's actual experience rather than generic claims.",
  },
  {
    number: "02",
...
const animationStyles = `
  @keyframes manufactureLeft {
    from { opacity: 0; transform: translateX(-30px); }
    to { opacity: 1; transform: translateX(0); }
  }

  @keyframes manufactureRight {
    from { opacity: 0; transform: translateX(30px); }
    to { opacity: 1; transform: translateX(0); }
  }

  @keyframes manufactureUp {
    from { opacity: 0; transform: translateY(24px); }
    to { opacity: 1; transform: translateY(0); }
  }

  .manufacture-left {
    animation: manufactureLeft .55s ease-out both;
  }

  .manufacture-right {
    animation: manufactureRight .55s ease-out both;
  }

  .manufacture-up {
    animation: manufactureUp .55s ease-out both;
  }

  .manufacture-card {
    animation: manufactureUp .5s ease-out both;
  }

  .manufacture-card:nth-child(1) { animation-delay: .03s; }
  .manufacture-card:nth-child(2) { animation-delay: .08s; }
  .manufacture-card:nth-child(3) { animation-delay: .13s; }
  .manufacture-card:nth-child(4) { animation-delay: .18s; }
  .manufacture-card:nth-child(5) { animation-delay: .23s; }
  .manufacture-card:nth-child(6) { animation-delay: .28s; }
      ...
      <div className="w-full overflow-hidden bg-white text-[#101828]">
        ...
        <section className="relative overflow-hidden bg-[#f7faff] px-14 py-14 sm:py-18 lg:py-20">
          ...
          <div className="relative mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 xl:px-10">
            <div className="mb-8 flex flex-wrap items-center gap-2 text-[11px] font-medium text-gray-500">
              ...
              <span>/</span>
              <span className="text-[#1455d9]">Manufacturing</span>
            </div>

            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
              <div className="manufacture-left max-w-[760px] pt-8">
                <p className="m-0 text-[10px] font-bold uppercase tracking-[0.2em] text-[#1455d9] sm:text-[11px]">
                  Manufacturing Digital Marketing
                </p>

                <h1 className="mt-4 m-0 max-w-[760px] text-[34px] font-bold leading-[1.06] tracking-[-0.04em] sm:text-[44px] md:text-[50px] lg:text-[30px]">
                  Digital Marketing for Manufacturing Businesses That Need
              ...
              {/* RIGHT HERO IMAGE */}
              <div className="manufacture-right relative flex items-center justify-center">
                ...
                <div className="relative w-full max-w-[600px] overflow-hidden rounded-[28px] border border-blue-100 bg-white p-2 shadow-[0_25px_70px_rgba(15,23,42,.10)]">
                  <img
                    src="/assets/images/content_images/manufacture.png"
                    alt="Manufacturing Digital Marketing"
        ...
        <section className="px-14 py-16 sm:py-20 lg:py-24">
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            <div className="manufacture-left">
              ...
              <h2 className="mt-4 m-0 text-[30px] font-bold leading-tight tracking-[-0.03em] sm:text-[33px]">
        ...
        <section className="bg-[#f7faff] px-14 py-16 sm:py-20 lg:py-24">
          <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-8 xl:px-10">
            <div className="manufacture-up text-center">
              <p className="m-0 text-[10px] font-bold uppercase tracking-[0.2em] text-[#1455d9]">
                Digital Opportunities
              </p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {opportunities.map((item) => (
                <article
                  key={item.number}
                  className="manufacture-card group rounded-[22px] border border-gray-200 bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,.04)] transition-all duration-300 hover:-translate-y-1 hover:border-blue-100 hover:shadow-[0_18px_45px_rgba(15,23,42,.08)] sm:p-7"
                >
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div className="space-y-3">
              {strategy.map((item) => (
                <div
                  key={item.number}
                  className="manufacture-card flex gap-5 rounded-[18px] border border-gray-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md sm:p-6"
                >
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:items-center lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {whyChoose.map((item) => (
                <div
                  key={item}
                  className="manufacture-card flex gap-3 rounded-[16px] border border-white/10 bg-white/[0.04] p-5 transition hover:bg-white/[0.07]"
                >
        ...
        <section className="px-14 py-16 sm:py-20 lg:py-24">
          <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            <div className="manufacture-left lg:sticky lg:top-28 lg:self-start">
              <p className="m-0 text-[10px] font-bold uppercase tracking-[0.2em] text-[#1455d9] sm:text-[11px]">
            ...
            <div className="manufacture-right space-y-3">
              {faqs.map((faq, index) => {
        ...
        <section className="relative overflow-hidden bg-[#073b91] px-14 py-10 sm:py-12 lg:py-14">
          ...
          <div className="manufacture-up relative mx-auto max-w-[1050px] px-4 text-center sm:px-6 lg:px-8">
            <h2 className="m-0 text-[30px] font-bold leading-tight tracking-[-0.03em] text-white sm:text-[38px] lg:text-[41px]">
              Ready to grow your manufacturing business online?
            </h2>

            <p className="mx-auto mt-3 max-w-[820px] text-[14px] leading-6 text-blue-100 sm:text-[15px]">
            ...
            <Link
              to="/contact"
              className="mt-5 inline-flex items-center rounded-full bg-white px-7 py-3 text-[13px] font-bold text-[#073b91] transition duration-300 hover:-translate-y-1 hover:bg-gray-100"
            >
              Build My Industry Growth Strategy
              <span className="ml-2">→</span>
            </Link>
