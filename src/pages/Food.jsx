...
const industryData = {
  food: {
    ...
    hero: "Digital Marketing for Food Businesses That Need Better Visibility, Trust & Leads",
    intro: "Food customers have a specific buying journey. Akkurate builds digital strategies around the questions, comparisons, trust signals and conversion actions that matter in this market.",
    problemTitle: "Why Food Marketing Needs a Specialized Approach",
    problem: "A generic digital marketing package rarely reflects the way food buyers search, compare and decide. The website should use industry language, answer relevant questions, demonstrate credible expertise and connect discovery channels to a clear commercial next step. Akkurate maps the customer journey first and then selects the right mix of SEO, AEO, GEO, paid media, website, content and branding services.",
    opportunities: [('Local SEO', 'Improve visibility for relevant local food searches and customer intent.'), ('Google Business Profile', 'Strengthen the connection between local discovery and business information.'), ('Reviews & Reputation', 'Support a practical process for genuine customer feedback and professional responses.'), ('Reels & Visual Content', 'Use visual content to communicate food, brand personality and offers.'), ('Local Paid Campaigns', 'Reach relevant local audiences with focused paid campaigns.'), ('Menu/Order Journeys', 'Connect discovery with clear menu, enquiry, ordering or purchase actions.')],
    finalCta: "Ready to grow your food business online? Tell Akkurate what you offer, who you want to reach and what outcome matters most.",
  },
};
...
export default function IndustryPage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-[#151b2c]">
      {/* Digital Marketing for Food Businesses That Need Better Visibility, Trust & Leads */}
      ...
      {/* [('Local SEO', 'Improve visibility for relevant local food searches and customer intent.'), ('Google Business Profile', 'Strengthen the connection between local discovery and business information.'), ('Reviews & Reputation', 'Support a practical process for genuine customer feedback and professional responses.'), ('Reels & Visual Content', 'Use visual content to communicate food, brand personality and offers.'), ('Local Paid Campaigns', 'Reach relevant local audiences with focused paid campaigns.'), ('Menu/Order Journeys', 'Connect discovery with clear menu, enquiry, ordering or purchase actions.')] */}
      <section className="px-14 py-16 sm:py-20 lg:py-24">
