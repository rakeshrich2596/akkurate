...
const industryData = {
  jewellery: {
    ...
    intro: "Jewellery customers have a specific buying journey. Akkurate builds digital strategies around the questions, comparisons, trust signals and conversion actions that matter in this market.",
    ...
    opportunities: [('Product & Category SEO', 'Build visibility around product categories and real jewellery customer intent.'), ('Social Visual Content', 'Use visual content to communicate products, style and brand story.'), ('Google & Meta Ads', 'Support product discovery and campaigns with paid media.'), ('E-Commerce UX', 'Create a smoother online shopping journey that helps customers evaluate products.'), ('Trust & Product Storytelling', 'Communicate product value, credibility and relevant brand stories.'), ('Local Discovery', 'Strengthen discovery for customers seeking relevant jewellery businesses locally.')],
    finalCta: "Ready to grow your jewellery business online? Tell Akkurate what you offer, who you want to reach and what outcome matters most.",
  },
};
...
export default function IndustryPage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-[#151b2c]">
      {/* Digital Marketing for Jewellery Businesses That Need Better Visibility, Trust & Leads */}
      ...
      {/* [('Product & Category SEO', 'Build visibility around product categories and real jewellery customer intent.'), ('Social Visual Content', 'Use visual content to communicate products, style and brand story.'), ('Google & Meta Ads', 'Support product discovery and campaigns with paid media.'), ('E-Commerce UX', 'Create a smoother online shopping journey that helps customers evaluate products.'), ('Trust & Product Storytelling', 'Communicate product value, credibility and relevant brand stories.'), ('Local Discovery', 'Strengthen discovery for customers seeking relevant jewellery businesses locally.')] */}
      <section className="px-14 py-16 sm:py-20 lg:py-24">
