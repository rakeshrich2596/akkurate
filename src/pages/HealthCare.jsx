...
const opportunities = [
  {
    ...
    description:
      "Develop this around real healthcare customer intent, commercial context and proof. The final page should include examples and evidence specific to Akkurate's actual experience rather than generic claims.",
  },
  {
    number: "02",
    title: "Local Search",
...
function ScrollAnimations() {
  ...
  return (
    <style>{`
      ...
      [data-delay="2"] { transition-delay: 0.07s; }
      [data-delay="3"] { transition-delay: 0.12s; }
      [data-delay="4"] { transition-delay: 0.17s; }
      [data-delay="5"] { transition-delay: 0.22s; }
      [data-delay="6"] { transition-delay: 0.27s; }
    ...
    <>
        ...
        <section className="relative overflow-hidden bg-[#f7faff] px-14 py-14 sm:py-18 lg:py-20">
          ...
          <div className="relative mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 xl:px-10">
            <div className="mb-8 flex flex-wrap items-center gap-2 text-[11px] font-medium text-gray-500">
              ...
              <span>/</span>
              <span className="text-[#1455d9]">Healthcare</span>
            </div>
            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
              <div data-animate="left" className="max-w-[760px] pt-8">
                ...
                <p className="mt-6 max-w-[680px] text-[14px] leading-7 text-gray-600 sm:text-[16px]">
                  Healthcare customers have a specific buying journey. Akkurate
              ...
              <div data-animate="right" className="relative flex items-center justify-center">
                <div className="relative w-full max-w-[600px] overflow-hidden rounded-[28px]">
                  <img
                    src="/assets/images/content_images/healthcare.png"
      ...
      "
          ...
          <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            ...
            <div data-animate="right">
              <p className="m-0 text-[14px] leading-7 text-gray-600 sm:text-[16px] sm:leading-8">
                ...
                healthcare buyers search, compare and decide. The website should
          ...
          <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16 lg:px-8 xl:px-10">
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <p className="mt-5 max-w-[430px] text-[14px] leading-7 text-gray-600 sm:text-[15px]">
                ...
                healthcare marketing, channels, websites and performance.
              </p>
            </div>
        ...
        <section className="relative overflow-hidden bg-[#073b91] px-14 py-10 sm:py-12 lg:py-14">
          ...
          >
            <h2 className="mt-0 m-0 text-[30px] font-bold leading-tight tracking-[-0.03em] text-white sm:text-[38px] lg:text-[40px]">
