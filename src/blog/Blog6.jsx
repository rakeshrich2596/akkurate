...
const Blog6 = () => {
  ...
  useEffect(() => {
    document.title = 'How to Build a B2B Digital Marketing Strategy in 2026 | Akkurate Digital Solutions';
    ...
    meta.setAttribute("content", 'A practical guide to b2b digital marketing strategy, including strategy, examples, common mistakes and actionable next steps from Akkurate Digital Solutions.');
        ...
        <section className="relative overflow-hidden bg-[#071a46] px-5 pb-16 pt-24 text-white sm:px-8 lg:px-12 lg:pb-24 lg:pt-32">
          ...
          <div className="relative z-10 mx-auto max-w-[1150px]">
            ...
            <p className="blog-reveal mt-7 max-w-[800px] text-[15px] leading-[1.8] text-slate-300 sm:text-[17px]">
              A B2B digital marketing strategy should connect business goals with the information buyers need throughout a longer decision-making journey.
            </p>
            ...
            <div className="blog-reveal mt-12 grid gap-4 sm:grid-cols-3">
              <div className="hero-card"><span>POSITIONING</span><h3>Be specific</h3><p>Make the proposition easy for the right audience to understand.</p></div>
<div className="hero-card"><span>CONTENT</span><h3>Support decisions</h3><p>Create content around problems, questions, use cases and buying considerations.</p></div>
<div className="hero-card"><span>LEAD JOURNEY</span><h3>Build trust</h3><p>Give prospects useful reasons to move from discovery to conversation.</p></div>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-[1150px] gap-12 lg:grid-cols-[260px_minmax(0,1fr)] lg:gap-16">
            ...
            <article className="min-w-0">
              ...
              <div id="introduction" data-blog-section className="blog-reveal">
                <p className="eyebrow">b2b digital marketing strategy</p>
                <h2 className="section-title">A practical introduction</h2>
                <div className="prose-blog">
                  <p>A B2B digital marketing strategy should connect business goals with the information buyers need throughout a longer decision-making journey.</p>
              ...
              <div id="what-is-it" data-blog-section className="blog-reveal">
                ...
                <p className="prose-blog mt-6">B2B buyers often research extensively before contacting a provider. Digital marketing should therefore support awareness, education, evaluation and conversion.</p>
                <div className="mt-9 grid gap-5 md:grid-cols-3">
                  <div className="blog-card"><span>POSITIONING</span><h3>Be specific</h3><p>Make the proposition easy for the right audience to understand.</p></div>
<div className="blog-card"><span>CONTENT</span><h3>Support decisions</h3><p>Create content around problems, questions, use cases and buying considerations.</p></div>
<div className="blog-card"><span>LEAD JOURNEY</span><h3>Build trust</h3><p>Give prospects useful reasons to move from discovery to conversation.</p></div>
                </div>
              </div>
              ...
              <div id="how-it-works" data-blog-section className="blog-reveal">
                ...
                <div className="prose-blog mt-6">
                  <p>B2B buyers often research extensively before contacting a provider. Digital marketing should therefore support awareness, education, evaluation and conversion.</p>
              ...
              <div id="what-first" data-blog-section className="blog-reveal">
                ...
                <div className="prose-blog mt-6">
                  <p>Begin by mapping the buying journey and the questions prospects ask at each stage. Then connect pages, content and conversion paths to those needs.</p>
                </div>
              ...
              <div id="examples" data-blog-section className="blog-reveal">
                ...
                <div className="mt-8 grid gap-5 md:grid-cols-2">
                  <div className="blog-card"><h3>Industrial company</h3><p>Create application pages, technical resources, industry pages and enquiry paths.</p></div>
<div className="blog-card"><h3>Professional services</h3><p>Use expertise-led articles, service pages and clear consultation CTAs.</p></div>
                </div>
              </div>
              ...
              <div id="faqs" data-blog-section className="blog-reveal">
                ...
                <div className="mt-8 space-y-3">
                  <details className="rounded-xl border border-slate-200 p-5"><summary className="cursor-pointer text-[14px] font-semibold">What is the first step?</summary><p className="mt-4 text-[13px] leading-7 text-slate-500">Define the ideal customer, commercial objective and buying journey.</p></details>
<details className="rounded-xl border border-slate-200 p-5"><summary className="cursor-pointer text-[14px] font-semibold">Which channels should B2B companies use?</summary><p className="mt-4 text-[13px] leading-7 text-slate-500">Choose based on audience behaviour, market and business objectives.</p></details>
<details className="rounded-xl border border-slate-200 p-5"><summary className="cursor-pointer text-[14px] font-semibold">How important is content?</summary><p className="mt-4 text-[13px] leading-7 text-slate-500">Useful content can help prospects understand problems and evaluate options.</p></details>
                </div>
              </div>
              ...
              <div id="akkurate-help" data-blog-section className="blog-reveal">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <Link to="/b2b-marketing" className="rounded-full border border-slate-200 px-5 py-3 text-[12px] font-semibold transition hover:border-[#1455d9] hover:text-[#1455d9]">Explore B2B Marketing</Link>
